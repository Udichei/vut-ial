...
void DLL_Init( DLList *list ) {
    ...
    list->activeElement = (struct DLLElement*)malloc(sizeof (struct DLLElement));
    list->firstElement = (struct DLLElement*)malloc(sizeof (struct DLLElement));
    list->lastElement = (struct DLLElement*)malloc(sizeof (struct DLLElement));
//
...
void DLL_InsertFirst( DLList *list, int data ) {
    ...
    if(malloc(sizeof (struct DLLElement)))
    {
        struct DLLElement *temp = (struct DLLElement*)malloc(sizeof (struct DLLElement));
...
void DLL_DeleteLast( DLList *list ) {
    ...
    if(list->lastElement != NULL)
    {
        ...
        if(list->lastElement->previousElement != NULL)
        {
            ...
            previous = list->lastElement->previousElement;
            free(list->lastElement);
...
void DLL_DeleteAfter( DLList *list ) {
    ...
    if(list->activeElement != NULL && list->activeElement != list->lastElement)
    {
        ...
        {
            next = list->activeElement->nextElement->nextElement;
            previous = list->activeElement;

            list->activeElement->nextElement->nextElement->previousElement = previous;
            free(list->activeElement->nextElement);
...
void DLL_DeleteBefore( DLList *list ) {
    ...
    {
        if(list->firstElement == list->activeElement->previousElement)
        {
        ...
        {
            next = list->activeElement;
            previous = list->activeElement->previousElement->previousElement;

            list->activeElement->previousElement->previousElement->nextElement = next;
            free(list->activeElement->previousElement);
...
void DLL_InsertAfter( DLList *list, int data ) {
    ...
    if(list->activeElement != NULL && !malloc(sizeof (struct DLLElement)))
    {
        struct DLLElement *temp = (struct DLLElement*)malloc(sizeof (struct DLLElement));
